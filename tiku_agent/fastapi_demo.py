...
<script>
const chat=document.querySelector('#chat'),empty=document.querySelector('#empty'),text=document.querySelector('#text'),file=document.querySelector('#file'),form=document.querySelector('#composer'),send=document.querySelector('#send'),newChat=document.querySelector('#new-chat'),dropOverlay=document.querySelector('#drop-overlay'),status=document.querySelector('#status'),statusText=document.querySelector('#status-text');
