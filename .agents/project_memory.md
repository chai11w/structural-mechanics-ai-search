...
- 8790 已于 2026-09-04 启用 `answer-session-v9` 固定 release；进程链、唯一 listener、健康/Trace、静态资源和生产认证均通过。回退包 `8790-answer-session-v9-20260904-100124` 含旧任务 XML、Git bundle 和 9 份 SQLite 副本。
